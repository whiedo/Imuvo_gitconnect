...
public class CustomSpinnerMultiSelection extends Spinner implements DialogInterface.OnMultiChoiceClickListener{
    ...
    public CustomSpinnerMultiSelection(Context context)
    {
        super(context);
    ...
    public CustomSpinnerMultiSelection(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public boolean performClick() {
        ...
        tv.setText(R.string.selectLection);
